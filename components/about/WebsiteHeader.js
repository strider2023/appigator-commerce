...
function WebsiteHeader() {
    return (
        <div className={styles.webisteHeaderContainer}>
            <Grid container className={styles.webisteHeaderTextContainer}>
                <Grid item xs={12} sm={6}>
                    <div className={styles.webisteHeaderText}>
            ...
            <div className={styles.innerWrap}>
                <svg className={styles.waves} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 960 214.5" preserveAspectRatio="xMinYMid meet">
                    <defs>
                        <style>
                        </style>
                        <linearGradient id="a">
